...
class Encoder(nn.Module):
    ...
    def forward(self, src): # lengths of src instances
        ...
        #packed = pack_padded_sequence(embedded, lengths,enforce_sorted=False)  # didn't sort the input sequence in batch
        outputs, hidden = self.rnn(embedded) # wonder what is hidden shape here.
        #print('last hidden shape: ', hidden.shape)
        #print('outputs: ', outputs.shape)
        #outputs , _ = pad_packed_sequence(outputs, total_length=max_length)  #unpack
        #print('unpacked ouputs: ', outputs.shape)
